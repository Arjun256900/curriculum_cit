        ...
        <div className = "w-full flex items-center justify-center gap-10">
            {
                courseData.map(course => (
                    <div key={course.course_id} className="bg-black text-white border-1 border-white p-4 w-full rounded-3xl hover:scale-105 transition-all duration-300 cursor-pointer flex flex-col hover:border-1 hover:border-white hover:shadow-[0_0_15px_5px_rgba(255,255,255,0.8)]">
